...
export const createHtml=(tokenEmail)=>{
    return `<!DOCTYPE html>
<html>
<head>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                          <a href="http://localhost:3000/user/confirm/${tokenEmail}" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">Do Something Sweet</a>
                        </td>
                      </tr>
                    </table>
                  </td>
...
export const sendEmail=async({from='"Maddison Foo Koch 👻" <fs4191884@gmail.com>',to,subject="confirm your email",html}={})=>{
